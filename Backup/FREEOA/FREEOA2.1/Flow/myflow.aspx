<%@ page language="C#" autoeventwireup="true" inherits="Flow_myflow, App_Web_i0ssc6n9" %>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="title" FooterText="title" HeaderText="名称" />
                            <asp:BoundField DataField="pubdate" HeaderText="起草时间" />
                            <asp:BoundField DataField="isurgent" FooterText="isurgent" HeaderText="紧急程度" />
                            ...
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" 
                                        CommandName="<%#bind('flowid') %>" oncommand="LinkButton2_Command" OnClientClick="return confirm('真的要删除该项工作流么？')">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
