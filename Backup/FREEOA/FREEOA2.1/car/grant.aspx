<%@ page language="C#" autoeventwireup="true" inherits="car_grant, App_Web_57g-_lwi" enableeventvalidation="false" %>
...
<body>
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td align="center" colspan="3">
                    <asp:GridView ID="grdCar" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" 
                        BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        GridLines="Horizontal" 
                        onpageindexchanging="grdMeetingroom_PageIndexChanging" Width="90%" 
                        Font-Size="Small" onrowdatabound="grdCar_RowDataBound" >
                            ...
                            <asp:TemplateField HeaderText="同意">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" 
                                        CommandArgument="<%#Bind('id') %>" oncommand="LinkButton2_Command"  >同意</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="拒绝">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton3" runat="server" 
                                        CommandArgument="<%#Bind('id') %>" oncommand="LinkButton3_Command">拒绝</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" 
                                        ...
                                        OnClientClick="return confirm('确定要删除此项记录么？')" 
