<%@ page language="C#" autoeventwireup="true" inherits="UserWork_MailListC, App_Web_65ubaf-d" %>
...
<div></div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width="100%">
				<tr height="30">
					...
					<td background="../Images/topbg.jpg" width="80"><b>草稿箱</b></td>
    ...
    <td align=left>
        <div align="center">
            <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#E7E7FF"
                ...
                AutoGenerateColumns="False" DataKeyNames="DraftId" 
                OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" 
                OnRowDeleting="GridView1_RowDeleting" GridLines="Horizontal" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="addDate" HeaderText="编写时间" />
                    <asp:CommandField EditText="查看" HeaderText="查看" ShowEditButton="True" />
                    <asp:CommandField HeaderText="删除" ShowDeleteButton="True" />
                    <asp:BoundField DataField="DraftId" HeaderText="DraftId" Visible="False" />
                </Columns>
