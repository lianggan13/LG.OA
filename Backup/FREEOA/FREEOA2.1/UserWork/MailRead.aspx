<%@ page language="C#" autoeventwireup="true" inherits="MailRead1, App_Web_65ubaf-d" %>
...
<body>
    ...
    <tr>
    <td width="10%"  align="right" class="style1" bgcolor="#EDF1FC">
        邮件主题：</td>
    ...
    <tr>
    <td width="10%"  align="right" class="style2" bgcolor="#EDF1FC">
    附件：</td>
    <td align="left" class="style2">
   <asp:Label ID="LblAcc" runat="server" BackColor="#EDF1FC" ></asp:Label>

    </td>
    </tr>
    <tr>
    <td align="right" style="height:200px" bgcolor="#EDF1FC">邮件内容：</td>
           ...
           <table style="width:98%;">
               <tr>
                   <td align="center" class="style3">
                       <asp:Button ID="btnReply" runat="server" Text="回 复" onclick="btnReply_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                       <asp:Button ID="btnToOther" runat="server" onclick="btnToOther_Click" 
                           Text="转 发" Width="46px" />
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                       <input id="btnBack" type="button" 
                           value="返 回" onclick="history.go(-1)" /></td>
               </tr>
           </table>
</form>
</body>
