<%@ page language="C#" autoeventwireup="true" inherits="Info_RestBranch, App_Web_wy4mt_ds" %>
...
<body>
    ...
    <div>
        ...
        <tr height="30">
					<td width="3%" background="../Images/topbg.jpg" align=left style="height: 30px"><IMG height="16" src="../Images/icon/right.GIF"><b>员工列表</b>
					</td>
            ...
            <tr>
                <td align="center">
                    请输入员工姓名：<asp:TextBox ID="TextBox1" runat="server" Width="114px" Height="14px"></asp:TextBox>&nbsp;
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" Height="71px" Width="850px" 
